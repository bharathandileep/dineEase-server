...
export const MONGO_DB_USERNAME: string | undefined = process.env.MONGO_DB_USERNAME;
export const MONGO_DB_PASSWORD: string | undefined = process.env.MONGO_DB_PASSWORD;
